...
| `/var/log/lumi/snapshots/sensing_<prefix>/<ms>.jpg` | Camera snapshots per event, bucketed by event prefix (`sensing_presence/`, `sensing_motion_activity/`, `sensing_emotion/`, …) | TTL 72h + 50 MB cap |
