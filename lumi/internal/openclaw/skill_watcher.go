...
func (s *Service) notifySkillChanges(changedSkills []string) {
	...
	msg := fmt.Sprintf("[system] The following skills have been updated. Re-read them now — files on disk have changed. Follow the updated instructions strictly. Reply NO_REPLY.%s", list)
