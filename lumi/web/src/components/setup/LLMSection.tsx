import { LockedField, LockedPasswordField, SectionCard } from "./shared";
...
export function LLMSection({
  ...
  // llmDisableThinking checkbox is hidden — see commented JSX below for the
  // original control. The page still owns the state and submits whatever
  ...
  return (
    <SectionCard id="llm" title="AI Brain" active={active}>
      ...
      {/* Hidden — re-enable by uncommenting and restoring the props above.
