...
const TYPE_LABEL: Record<string, string> = {
  ...
  motion: "motion", "motion.activity": "activity", "emotion.detected": "emotion", "speech_emotion.detected": "voice_emo", "presence.enter": "enter", "presence.leave": "leave", "presence.away": "away",
...
export function FlowSection({
  ...
  for (const ev of turnEvents) {
    ...
    const fromSensingAgentCall = (ev.type === "flow_event" && ev.detail?.node === "agent_call") &&
      (sensingType === "voice" || sensingType === "voice_command" || sensingType === "motion" || sensingType === "motion.activity" || sensingType === "emotion.detected" || sensingType === "speech_emotion.detected" || sensingType === "sound");
